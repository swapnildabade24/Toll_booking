          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Road</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Road Name">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label for="exampleInputPassword1">Road Distance</label>
                        <input type="number" class="form-control" id="exampleInputPassword1" placeholder="To">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label for="exampleInputPassword1">From</label>
                        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="From">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
